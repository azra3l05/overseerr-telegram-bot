...
class RadarrSonarrAPI:
    ...
    @retry_on_failure(max_retries=3, backoff_factor=2)
    def check_tv_availability(self, tvdb_id: int, season_number: Optional[int] = None) -> Tuple[bool, bool, int, int, Optional[Dict]]:
        """
        ...
        Returns:
            Tuple of (is_partially_available, is_fully_available, episodes_available, total_episodes, show_data)
            is_partially_available: True if at least one episode has a file
            is_fully_available: True if all episodes have files
            episodes_available: Number of episodes with files
        ...
        try:
            ...
            if season_number is not None:
                ...
                is_partially_available = episodes_with_files > 0
                is_fully_available = episodes_with_files == total_episodes
                ...
                return is_partially_available, is_fully_available, episodes_with_files, total_episodes, show
            else:
                # Check entire show
